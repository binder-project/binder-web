...
module.exports = function () {
  ...
  <div style=${styles.container}>
    ...
    <h2 style=${styles.attention}>Binder is upgrading and will be better than ever soon.<br />Check out <a href="http://beta.mybinder.org">beta.mybinder.org</a> to try it out!</h2>
