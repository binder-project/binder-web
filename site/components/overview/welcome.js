...
module.exports = function () {
  ...
  <div style=${styles.container}>
    ...
    <h2 style=${styles.attention}>Binder is currently upgrading and will be better than ever soon. In the meantime it might be a little unstable. Thanks for your patience!</h2>
